...
[CAUTION]
====
* E' possibile inviare una HTTP Request con body per verbo GET?
* E' corretto farlo?
====
...
E' possibile ottenere il medesimo risultato utilizzando un query string parameter e lasciando il path come impostato inizialmente:
