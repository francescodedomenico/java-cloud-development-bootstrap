...
video::N_bMCff8q6A[youtube, width=1280, height=720]

=== Spring Boot

video::vtPkZShrvXQ[youtube, width=1280, height=720]

=== Docker

video::3c-iBn73dDE[youtube, width=1280, height=720]

=== Kubernetes

video::X48VuDVv0do[youtube, width=1280, height=720]
